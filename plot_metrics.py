...
base_config = {'dataset': 'mnist', 'task': 'sup', 'l1': 0.0, 'l2': 1e-5, 'drop': 0.0, 'runs': 9, 'x_scale': 'linear',
               'figsize': (3, 2), 'eval': True}

configs = [
    {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'train_acc', 'y_lim': [0.0, 1.0]},
    {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'val_acc', 'y_lim': [0.0, 1.0]},
    {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'test_acc', 'y_lim': [0.0, 1.0]},
    {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'train_acc', 'y_lim': [0.0, 1.0]},
    {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'val_acc', 'y_lim': [0.0, 1.0]},
    {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'test_acc', 'y_lim': [0.0, 1.0]},
    {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'l1_norm', 'y_lim': [0, 3500]},
    {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'l2_norm', 'y_lim': [0, 700]},
    {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'l1_norm', 'y_lim': [0, 3500]},
    {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'l2_norm', 'y_lim': [0, 700]},
]

# configs = [
#     {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'modules.forward_cov.0.score', 'y_lim': [0.0, 0.3]},
#     {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'modules.forward_cov.0.score', 'y_lim': [0.0, 0.3]},
#     {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'modules.forward_cov_norm.0.score', 'y_lim': [0.0, 0.3]},
#     {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'modules.forward_cov_norm.0.score', 'y_lim': [0.0, 0.3]},
#     {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'modules.backward_hess.0.score', 'y_lim': [0.0, 0.3]},
#     {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'modules.backward_hess.0.score', 'y_lim': [0.0, 0.3]},
#     {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'modules.backward_hess_norm.0.score', 'y_lim': [0.0, 0.3]},
#     {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'modules.backward_hess_norm.0.score', 'y_lim': [0.0, 0.3]},
#     {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'modules.forward_cov.1.score', 'y_lim': [0.0, 0.3]},
#     {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'modules.forward_cov.1.score', 'y_lim': [0.0, 0.3]},
#     {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'modules.forward_cov_norm.1.score', 'y_lim': [0.0, 0.3]},
#     {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'modules.forward_cov_norm.1.score', 'y_lim': [0.0, 0.3]},
#     {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'modules.backward_hess.1.score', 'y_lim': [0.0, 0.3]},
#     {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'modules.backward_hess.1.score', 'y_lim': [0.0, 0.3]},
#     {'l2': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l2', 'y': 'modules.backward_hess_norm.1.score', 'y_lim': [0.0, 0.3]},
#     {'l1': torch.logspace(-5, -1, 9), 'x_scale': 'log', 'x': 'l1', 'y': 'modules.backward_hess_norm.1.score', 'y_lim': [0.0, 0.3]}
# ]
