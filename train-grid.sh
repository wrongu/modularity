...
parallel --linebuffer --tag --jobs=30 $ENV $PYTHON -m train --dataset={1} --task={2} --save-dir=logs --device=auto --devices=$CUDA_DEVICES --l2=0.0000001 --l1={3} --run={4} \
  ::: ${DATASETS[@]} ::: ${TASKS[@]} ::: ${L1VALS[@]} ::: ${RUNS[@]}

parallel --linebuffer --tag --jobs=30 $ENV $PYTHON -m train --dataset={1} --task={2} --save-dir=logs --device=auto --devices=$CUDA_DEVICES --l2=0.0000001 --drop={3} --run={4} \
  ::: ${DATASETS[@]} ::: ${TASKS[@]} ::: ${DROPVALS[@]} ::: ${RUNS[@]}
